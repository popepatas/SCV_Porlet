 ...
 * @author illustrato
 */
public class EliminarActEconomica {
     ...
     * @param error
     */
    public EliminarActEconomica(Integer codigo){
        this.codigo = codigo;
        db = new DbManager();
    }
    ...
    public void setError(int error) {
     ...
     /**
     *
     * Ejecuta el procedimiento almacenado SpEliminarActEconomica.
     *
     * @throws Exception
     */
    public void ejecutar() throws Exception{
        ...
        try{
            ...
            callableStatement = conn.prepareCall(Queries.
                    getString("SpEliminarActEconomica"));
