...
public class ActualizarTiposInformesVertimientos {
     ...
     * @param nombres 
     */
    public ActualizarTiposInformesVertimientos(int codigo, String nombres) {
    ...
    public void ejecutar() throws Exception{
        ...
        try{
            ...
            callableStatement = conn.prepareCall(Queries
                    .getString("SpActualizarTipoInforVertimiento"));
