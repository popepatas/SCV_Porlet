 ...
 * @author illustrato
 */
public class EliminarPrmfisicoquimicos {
     ...
     * @param error
     */
    public EliminarPrmfisicoquimicos(Integer codigo){
        this.codigo = codigo;
        db = new DbManager();
    }
    ...
    public void setError(int error) {
     ...
     /**
     *
     * Ejecuta el procedimiento almacenado SpEliminarPrmfisicoquimicos.
     *
     * @throws Exception
     */
    public void ejecutar() throws Exception{
        ...
        try{
            ...
            callableStatement = conn.prepareCall(Queries.
                    getString("SpEliminarPrmfisicoquimicos"));
