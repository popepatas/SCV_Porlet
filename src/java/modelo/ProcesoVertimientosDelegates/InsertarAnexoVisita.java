...
public class InsertarAnexoVisita {
    ...
    public InsertarAnexoVisita(int codigoVisita, File archivo, String nombreArchivo) throws FileNotFoundException {
