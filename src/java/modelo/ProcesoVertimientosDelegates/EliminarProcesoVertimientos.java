 ...
 * @author illustrato
 */
public class EliminarProcesoVertimientos {
     ...
     * @param codigo
     */
    public EliminarProcesoVertimientos(int codigo){
        this.codigo = codigo;
    ...
    public void setError(int error) {
     ...
     /**
     *
     * Ejecuta el procedimiento almacenado SpEliminarProcesosVertimientos.
     *
     * @throws Exception
     */
    public void ejecutar() throws Exception{
        ...
        try{
            ...
            callableStatement = conn.prepareCall(Queries.
                    getString("SpEliminarProcesosVertimientos"));
