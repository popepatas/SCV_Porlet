...
public class InsertarEntidadLodos {
    ...
    public InsertarEntidadLodos(String nombreEmpresa, String recolecta, String volumen, String fechaRecoleccion, String frecuencia, String transporte, String dispone, String sitioDispone, String codigo) {
    ...
    public void ejecutar() throws Exception{
        ...
        try{
            ...
            callableStatement = conn.prepareCall(Queries
                    .getString("SpInsertarEntidadesLodos"));
