...
@WebServlet(name = "ActualizarEntidadLodos", urlPatterns = {"/ActualizarEntidadLodos"})
public class ActualizarEntidadLodos extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String codigoLodos = request.getParameter("codigoLodo");
            
            ManejoLodos manager = new ManejoLodos();
            manager.actualizarEntidadLodos(nombreEmpresa, recolecta, volumen, fechaRecoleccion, frecuencia, transporte,
                                            dispone, sitioDispone, codigo, codigoLodos);
