 ...
 * @author Galatea
 */
@WebServlet(name = "SeleccionarDevolucionCaracterizacion", urlPatterns = {"/SeleccionarDevolucionCaracterizacion"})
public class SeleccionarDevolucionCaracterizacion extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            try {
                ...
                JSONArray jsonArray = manager.getDevolucionCaracterizacion(codigoProceso);
