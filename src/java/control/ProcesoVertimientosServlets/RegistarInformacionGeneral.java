 ...
 * @author illustrato
 */
@WebServlet(name = "RegistarInformacionGeneral", urlPatterns = {"/RegistarInformacionGeneral"})
public class RegistarInformacionGeneral extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
          ...
          try {
            ...
            String informaMonitore = request.getParameter("informo");
            
            
            InformacionGeneral manager = new InformacionGeneral();
      
            manager.registrar(requiereVisita, contacto, asunto, fecha_asesoria, codigoProceso, tipoContacto, tipoInforme, informaMonitore);
            
        } catch (Exception ex) {
           // Logger.getLogger(RegistarInformacionGeneral.class.getName()).log(Level.SEVERE, null, ex);
        }
