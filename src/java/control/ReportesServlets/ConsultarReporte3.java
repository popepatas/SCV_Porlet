 ...
 * @author Marcos
 */
@WebServlet(name = "ConsultarReporte3", urlPatterns = {"/ConsultarReporte3"})
public class ConsultarReporte3 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JSONArray jsonArray = manager.getReporte3(fechaInicial, fechaFinal, estadoVisita
                    , numeroContrato, nit, actividadProductiva, razonSocial, comuna
                    , laboratorio, usoServicio, tipoInforme, filaInicio.toString(), filaFin.toString());
            String json = null;
            ...
            //Logger.getLogger(Reporte3Cliente.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}