 ...
 * @author illustrato
 */
@WebServlet(name = "ActualizarHistorialDagma", urlPatterns = {"/ActualizarHistorialDagma"})
public class ActualizarHistorialDagma extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int codigoHistorial = Integer.parseInt(request.getParameter("codigoHistorial"));
            String observacion = request.getParameter("observacion");
            //Obtenemos La informacion del manager
            ReportesManager manager = new ReportesManager();
                        
            manager.actualizarRegistroDagma(radicado, fechaRadicado, proceso, tipoRadicado, codigoHistorial, observacion);
