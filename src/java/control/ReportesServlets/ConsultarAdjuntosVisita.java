 ...
 * @author Marcos
 */
@WebServlet(name = "ConsultarAdjuntosVisita", urlPatterns = {"/ConsultarAdjuntosVisita"})
public class ConsultarAdjuntosVisita extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JSONArray jsonArray = manager.getAdjuntosVisita(codigoVisita);
            String json = null;
