 ...
 * @author Marcos
 */
@WebServlet(name = "ConsultarMonitoreosProceso", urlPatterns = {"/ConsultarMonitoreosProceso"})
public class ConsultarMonitoreosProceso extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JSONArray jsonArray = manager.getMonitoreosProceso(codigoProceso);
            String json = null;
