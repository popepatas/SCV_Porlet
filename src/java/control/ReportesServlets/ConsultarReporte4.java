 ...
 * @author Marcos
 */
@WebServlet(name = "ConsultarReporte4", urlPatterns = {"/ConsultarReporte4"})
public class ConsultarReporte4 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JSONArray jsonArray = manager.getReporte4(fechaInicial, fechaFinal, estadoProceso, numeroContrato
            ...
            //Logger.getLogger(Reporte4Cliente.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}