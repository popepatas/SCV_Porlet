 ...
 * @author Marcos
 */
@WebServlet(name = "ConsultarReporte2", urlPatterns = {"/ConsultarReporte2"})
public class ConsultarReporte2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JSONArray jsonArray = manager.getReporte2(fechaInicial, fechaFinal, estadoProceso
