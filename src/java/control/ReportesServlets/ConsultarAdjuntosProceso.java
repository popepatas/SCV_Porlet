 ...
 * @author Marcos
 */
@WebServlet(name = "ConsultarAdjuntosProceso", urlPatterns = {"/ConsultarAdjuntosProceso"})
public class ConsultarAdjuntosProceso extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JSONArray jsonArray = manager.getAdjuntosProceso(codigoProceso);
            String json = null;
