 ...
 * @author Marcos
 */
@WebServlet(name = "ConsultarHistorialDagmaProceso", urlPatterns = {"/ConsultarHistorialDagmaProceso"})
public class ConsultarHistorialDagmaProceso extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            JSONArray jsonArray = manager.getHistorialDagmaProceso(codigoProceso);
            String json = null;
