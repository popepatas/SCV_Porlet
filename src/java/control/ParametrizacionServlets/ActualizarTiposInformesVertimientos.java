 ...
 * @author Galatea
 */
@WebServlet(name = "ActualizarTiposInformesVertimientos", urlPatterns = {"/ActualizarTiposInformesVertimientos"})
public class ActualizarTiposInformesVertimientos extends HttpServlet {
