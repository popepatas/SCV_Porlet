 ...
 * @author illustrato
 */
@WebServlet(name = "InsertarTiposInformeVertimientos", urlPatterns = {"/InsertarTiposInformeVertimientos"})
public class InsertarTiposInformeVertimientos extends HttpServlet {
