 ...
 * @author Galatea
 */
@WebServlet(name = "InsertarTiposPrmfisicoquimicos", urlPatterns = {"/InsertarTiposPrmfisicoquimicos"})
public class InsertarTiposPrmfisicoquimicos extends HttpServlet {
