 ...
 * @author Galatea
 */
@WebServlet(name = "ActualizarAsociacionContratos", urlPatterns = {"/ActualizarAsociacionContratos"})
public class ActualizarAsociacionContratos extends HttpServlet {

private  JSONObject objectErrores = new JSONObject();
private  JSONArray arrayErrores = new JSONArray();
