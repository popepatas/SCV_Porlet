 ...
 * @author Galatea
 */
@WebServlet(name = "SeleccionarMotivosVisitas", urlPatterns = {"/SeleccionarMotivosVisitas"})
public class SeleccionarMotivosVisitas extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(opcion){
            ...
            case 1:{
                getMotivosVisitas(request, response);
            }
                break;
                
            //Obtenemos una actividad economica especifica.    
            case 2:{
                getMotivoVisita(request, response);
            }
                break;
        }
    }
     ...
     * @param response 
     */
    private void getMotivosVisitas(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            ...
            JSONArray jsonArray = manager.getMotivosVisitas(descripcion);
