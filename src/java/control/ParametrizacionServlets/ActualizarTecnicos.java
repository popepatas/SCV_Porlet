 ...
 * @author illustrato
 */
@WebServlet(name = "ActualizarTecnicos", urlPatterns = {"/ActualizarTecnicos"})
public class ActualizarTecnicos extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         try {  
              ...
              manager.actualizar(codigo, nombres, apellidos, tipoDocumento, documento, estado, tipoPersona);
