 ...
 * @author illustrato
 */
@WebServlet(name = "ActualizarActParamfisicoquimicos", urlPatterns = {"/ActualizarActParamfisicoquimicos"})
public class ActualizarActParamfisicoquimicos extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
         ...
         try {   
           ...
           //Creamos el manager para registrar la informacion
            ...
            respError = manager.actualizar(codigo,actividad, parametro, rangoInicial, rangoFinal, mayorInicial, mayorFinal,mostrarRango);
