 ...
 * @author Galatea
 */
@WebServlet(name = "ActualizarTiposPrmfisicoquimicos", urlPatterns = {"/ActualizarTiposPrmfisicoquimicos"})
public class ActualizarTiposPrmfisicoquimicos extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            manager.actualizar(codigo, descripcion);
