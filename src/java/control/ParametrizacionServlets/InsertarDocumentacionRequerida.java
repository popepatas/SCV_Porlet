 ...
 * @author illustrato
 */
@WebServlet(name = "InsertarDocumentacionRequerida", urlPatterns = {"/InsertarDocumentacionRequerida"})
public class InsertarDocumentacionRequerida extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            manager.insertar(descripcion, tipoInforme);
