 ...
 * @author Galatea
 */
@WebServlet(name = "SeleccionarAsociacionContratos", urlPatterns = {"/SeleccionarAsociacionContratos"})
public class SeleccionarAsociacionContratos extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        switch(opcion){
            ...
            case 1:{
                getAsociaciones(request, response);
            }
                break;
                
            //Obtenemos una actividad economica especifica.    
            case 2:{
                getAsociacion(request, response);
            }
                break;
        }
     ...
     * @param response 
     */
    private void getAsociaciones(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            ...
            JSONArray jsonArray = manager.getAsociaciones(contrato);
