 ...
 * @author illustrato
 */
@WebServlet(name = "ActualizarConsultores", urlPatterns = {"/ActualizarConsultores"})
public class ActualizarConsultores extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
               ...
               manager.actualizar(nombre, apellidos, direccion, telefono, telefono2, correo, identificacion, codigo);
