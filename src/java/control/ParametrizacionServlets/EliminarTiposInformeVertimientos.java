 ...
 * @author illustrato
 */
@WebServlet(name = "EliminarTiposInformeVertimientos", urlPatterns = {"/EliminarTiposInformeVertimientos"})
public class EliminarTiposInformeVertimientos extends HttpServlet {
