...
<html>
	...
	<script type="text/javascript" src="../js/funciones/reportes/consultarReporte2.js"></script>
                    ...
                    <div class="contenidoPrincipal" >
                        <div id="Wrapper">
                            <section class="k-content">
                                <div id="div_Reporte2" class="formularios">
                                    <div class="titulo">Criterios de Consulta: Reporte Seguimiento de Estados</div><br>
                                    ...
                                    <div class="contenedorEstado">
                                        <div class="etiquetas"><label for="estadoProceso">Estado Actual Proceso:</label></div>
                                        <div class="campos">
                        ...
                        <div>
                            <section class="contenedor-grilla">
                                <div id="grillaReporte2" style="width:1500px;"></div>
                            </section>
                        </div>
                        <div>
                            <form id="exportToExcelForm" action="/SCV_Portlet/exportarExcel" method="POST" target="exportToExcelHiddenFrame">
                                ...
                                <input type="hidden" id="nombreReporte" name="nombreReporte" value="Reporte2" />
                            </form>
