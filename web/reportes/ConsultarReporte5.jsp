...
<html>
	...
	<script type="text/javascript" src="../js/funciones/reportes/consultarReporte5.js"></script>
                    ...
                    <div class="contenidoPrincipal" >
                        <div id="Wrapper">
                            <section class="k-content">
                                <div id="div_Reporte5" class="formularios">
                                    <div class="titulo">Criterios de Consulta: Empresas a Monitorear</div><br>
                        ...
                        <div>
                            <section class="contenedor-grilla">
                                <div id="grillaReporte5" style="width:1500px;"></div>
                            </section>
                        </div>
                        <div>
                            <form id="exportToExcelForm" action="/SCV_Portlet/exportarExcel" method="POST" target="exportToExcelHiddenFrame">
                                ...
                                <input type="hidden" id="nombreReporte" name="nombreReporte" value="Reporte5" />
                            </form>
