<%-- 
    Document   : ConsultarReporte6
    Created on : 11/03/2014, 11:47:53 AM
    Author     : jmrincon
--%>
...
<html>
	...
	<script type="text/javascript" src="../js/funciones/reportes/consultarReporte6.js"></script>
        
        <script type="text/javascript" src="../js/librerias/Kendo/js/kendo.all.min.js"></script>
                    ...
                    <div class="contenidoPrincipal" >
                        <div id="Wrapper">
                            <section class="k-content">
                                <div id="div_Reporte6" class="formularios">
                                    <div class="titulo">Criterios de Consulta: Parametro Fisicoquimico</div><br>
                                    ...
                                    <div class="contenedorEstado">
                                        ...
                                        <div class="campos">
                                            <select id="paramFisicoQuimico" multiple="multiple" required></select>
                                        </div>
                                    </div>
                                    <div id="rangosParam"></div>
                        ...
                        <div>
                            <section class="contenedor-grilla">
                                <div id="grillaReporte6" style="width:1500px;"></div>
                            </section>
                        </div>
                        <div>
                            <form id="exportToExcelForm" action="/SCV_Portlet/exportarExcel" method="POST" target="exportToExcelHiddenFrame">
                                ...
                                <input type="hidden" id="nombreReporte" name="nombreReporte" value="Reporte6" />
                            </form>
