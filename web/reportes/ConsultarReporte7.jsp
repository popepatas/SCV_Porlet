...
<html>
	...
	<script type="text/javascript" src="../js/funciones/reportes/consultarReporte7.js"></script>
                    ...
                    <div class="contenidoPrincipal" >
                        <div id="Wrapper">
                            <section class="k-content">
                                <div id="div_Reporte7" class="formularios">
                                    <div class="titulo">Criterios de Consulta: Produccion Lodo - Tasa Retributiva</div><br>
                                    ...
                                    <div class="contenedoUsoServicio">
                                        <div class="etiquetas"><label for="lodoInicial">Lodo Inicial:</label></div>
                                        <div class="campos">
                                            <input type="text" id="lodoInicial" name="lodoInicial"/>
                                            <span class="k-invalid-msg" data-for="lodoInicial"></span>
                                        </div>
                                    </div>
                                    <div class="contenedoUsoServicio">
                                        <div class="etiquetas"><label for="lodoFinal">Lodo Final:</label></div>
                                        <div class="campos">
                                            <input type="text" id="lodoFinal" name="lodoFinal"/>
                                            <span class="k-invalid-msg" data-for="lodoFinal"></span>
                                        </div>
                                    </div>
                                    <div class="contenedoUsoServicio">
                                        <div class="etiquetas"><label for="tasaInicial">Tasa Inicial:</label></div>
                                        <div class="campos">
                                            <input type="text" id="tasaInicial" name="tasaInicial"/>
                                            <span class="k-invalid-msg" data-for="tasaInicial"></span>
                                        </div>
                                    </div>
                                    <div class="contenedoUsoServicio">
                                        <div class="etiquetas"><label for="tasaFinal">Tasa Final:</label></div>
                                        <div class="campos">
                                            <input type="text" id="tasaFinal" name="tasaFinal"/>
                                            <span class="k-invalid-msg" data-for="tasaFinal"></span>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="botones">
                        ...
                        <div>
                            <section class="contenedor-grilla">
                                <div id="grillaReporte7" style="width:1500px;"></div>
                            </section>
                        </div>
                        <div>
                            <form id="exportToExcelForm" action="/SCV_Portlet/exportarExcel" method="POST" target="exportToExcelHiddenFrame">
                                ...
                                <input type="hidden" id="nombreReporte" name="nombreReporte" value="Reporte7" />
                            </form>
