<%-- 
    Document   : LogsHistorialDagma
    Created on : 28-Feb-2014, 12:09:32
    Author     : jmrincon
--%>
...
<div class="contenedor-grilla">
    <div id="grillaHistorialDagma" class="grilla-medium"></div>
    
    <div id="modalBoxAdjuntosHistorialDagma"></div>
</div>
<% } %>