...
<html>
	...
	<script type="text/javascript" src="../js/funciones/reportes/consultarReporte1.js"></script>
                    ...
                    <div class="contenidoPrincipal" >
                        <div id="Wrapper">
                            <section class="k-content">
                                <div id="div_Reporte1" class="formularios">
                                    <div class="titulo">Criterios de Consulta: Reporte de Caracterizacion y Proceso Seco</div><br>
                        ...
                        <div>
                            <form id="exportToExcelForm" action="/SCV_Portlet/exportarExcel" method="POST" target="exportToExcelHiddenFrame">
                                ...
                                <input type="hidden" id="nombreReporte" name="nombreReporte" value="Reporte1" />
                            </form>
