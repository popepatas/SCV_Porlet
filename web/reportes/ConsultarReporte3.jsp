...
<html>
	...
	<script type="text/javascript" src="../js/funciones/reportes/consultarReporte3.js"></script>
                    ...
                    <div class="contenidoPrincipal" >
                        <div id="Wrapper">
                            <section class="k-content">
                                <div id="div_Reporte3" class="formularios">
                                    <div class="titulo">Criterios de Consulta: Reporte de Visitas</div><br>
                                    ...
                                    <div class="contenedorEstado">
                                        <div class="etiquetas"><label for="estadoVisita">Estado Visita:</label></div>
                                        <div class="campos">
                                            <select id="estadoVisita" name="estadoVisita" class="k-textbox">
                                                <option value=""></option>
                                            </select>
                        ...
                        <div>
                            <section class="contenedor-grilla">
                                <div id="grillaReporte3" style="width:1500px;"></div>
                            </section>
                        </div>
                        <div>
                            <form id="exportToExcelForm" action="/SCV_Portlet/exportarExcel" method="POST" target="exportToExcelHiddenFrame">
                                ...
                                <input type="hidden" id="nombreReporte" name="nombreReporte" value="Reporte3" />
                            </form>
