<%-- 
    Document   : AdmonMonitoreo
    Created on : 28-Feb-2014, 14:31:19
    Author     : illustrato
--%>
...
<html>
    <head>
        ...
        <script type="text/javascript" src="../js/funciones/admonVisitas/AdmonMonitoreo.js"></script>
    ...
    <body>
        ...
        <section id="Wrapper">
            ...
            <section id="ContenedorContent">
                   ...
                   <%@include file="../proceso/ConsultarMonitoreo.jsp" %>    
