   ...
   <%@page import="modelo.UsuariosManagers.Usuarios"%>
    <!-- Verificamos si el usuario tiene permisos para ingresar a la pagina -->
        <%
            ...
            String username1 = (String)sesion1.getAttribute("login");              
             if(username1 == null){                           
                 response.sendRedirect("/SCV_Portlet/Login.jsp");               
             }else{                         
                 String pagina1 = this.getClass().getSimpleName().replaceAll("_", ".");                          
                 Usuarios manager1 = new Usuarios();                               
                 validar1 = manager1.verificarPermisos(username1, pagina1);               
             }
         %>
