...
<html>
	...
	<script type="text/javascript" src="../js/librerias/Kendo/js/kendo.numerictextbox.min.js"></script>
        ...
        <script type="text/javascript" src="../js/funciones/dashboard/consultarDashboard5.js"></script>
                    ...
                    <div class="contenidoPrincipal" >
                        <div id="Wrapper">
                            <section class="k-content">
                                <div id="div_Dashboard5" class="formularios">
                                    <div class="titulo">Evoluci&oacute;n DBO y SST</div><br>
                                    
                                    <div class="contenedorEstado">
                                        <div class="etiquetas"><label for="clientes">Cliente:</label></div>
                                        <div class="campos">
                                            <select id="clientes" name="clientes" class="k-textbox" required>
                                                <option value=""></option>
                                            </select>
                                    ...
                                    <div class="contenedoUsoServicio">
                                        <div class="etiquetas"><label for="rangoParamInicial">Rango Inicial Parametro:</label></div>
                                        <div class="campos">
                                            <input type="text" id="rangoParamInicial" name="rangoParamInicial" required/>
                                            <span class="k-invalid-msg" data-for="rangoParamInicial"></span>
                                        </div>
                                    </div>
                                    <div class="contenedoUsoServicio">
                                        <div class="etiquetas"><label for="rangoParamFinal">Rango Final Parametro:</label></div>
                                        <div class="campos">
                                            <input type="text" id="rangoParamFinal" name="rangoParamFinal" required/>
                                            <span class="k-invalid-msg" data-for="rangoParamFinal"></span>
                                        </div>
                                    </div>
                                    <div class="contenedoUsoServicio">
                        ...
                        <div>
                            <section class="contenedor-chart">
                                <div id="chartDashboard5" style="background: center no-repeat url('../images/mundo.jpg');"></div>
                            </section>
                        </div>
                    </div>
                </section>
