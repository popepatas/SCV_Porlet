...
<html>
	...
	<script type="text/javascript" src="../js/funciones/dashboard/consultarDashboard2.js"></script>
                    ...
                    <div class="contenidoPrincipal" >
                        <div id="Wrapper">
                            <section class="k-content">
                                <div id="div_Dashboard2" class="formularios">
                                    <div class="titulo">% Incumplimiento por Parametro y Rango de A&ntilde;os</div><br>
                        ...
                        <div>
                            <section class="contenedor-chart">
                                <div id="chartDashboard2" style="background: center no-repeat url('../images/mundo.jpg');"></div>
                            </section>
                        </div>
                    </div>
                </section>
