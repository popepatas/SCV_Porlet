...
<html>
	...
	<script type="text/javascript" src="../js/funciones/dashboard/consultarDashboard4.js"></script>
                    ...
                    <div class="contenidoPrincipal" >
                        <div id="Wrapper">
                            <section class="k-content">
                                <div id="div_Dashboard4" class="formularios">
                                    <div class="titulo">Criterios de Consulta: Evoluci&oacute;n Parametros</div><br>
                                    
                                    <div class="contenedorContrato">
                                        <div class="etiquetas"><label for="numeroContrato">Contrato:</label></div>
                                        <div class="campos">
                                            <input type="text" id="numeroContrato" name="numeroContrato" class="k-textbox"/>
                                    ...
                                    <div class="contenedorEstado">
                                        <div class="etiquetas"><label for="paramFisicoQuimico">Parametro Fisicoquimico:</label></div>
                                        <div class="campos">
                                            <select id="paramFisicoQuimico" name="paramFisicoQuimico" class="k-textbox" required>
                                                <option value=""></option>
                                            </select>
                                            <span class="k-invalid-msg" data-for="paramFisicoQuimico"></span>
                                        </div>
                                    </div>
                        ...
                        <div>
                            <section class="contenedor-chart">
                                <div id="chartDashboard4" style="background: center no-repeat url('../images/mundo.jpg');"></div>
                            </section>
                        </div>
                    </div>
                </section>
