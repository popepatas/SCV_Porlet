...
<html>
    <head>
        ...
        <script type="text/javascript" src="../js/funciones/parametrizacion/unidadesMedidas.js"></script>
        <script src="../js/funciones/masterPage.js" type="text/javascript"></script>
                        
        <title>SCV - Unidades de Medidas</title>
    </head>
    <body>
            ...
            <section id="ContenedorContent">
                <section id="Content">
                  <%@include file="../templates/main_nav.html" %>
                    ...
                    <div class="contenidoPrincipal" >
                        <div id="div_unidades_medidas" class="formularios">
