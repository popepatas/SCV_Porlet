...
<html>
    <head>
        ...
        <script type="text/javascript" src="../js/funciones/parametrizacion/tiposInformeVertimientos.js"></script>
        <script src="../js/funciones/masterPage.js" type="text/javascript"></script>
        
        <title>SCV - Tipos de Informes de Vertimientos</title>
    </head>
	<body>
            ...
            <section id="ContenedorContent">
                <section id="Content">
                    ...
                    <div class="contenidoPrincipal" >
                            ...
                            <div id="div_tipos_informes_vertimientos" class="formularios">
                                <h2>Tipos de Informe de Vertimientos</h2>
