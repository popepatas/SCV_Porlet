...
<html>
    <head>
        ...
        <script type="text/javascript" src="../js/funciones/parametrizacion/motivosVisitas.js"></script>
        <script type="text/javascript" src="../js/funciones/masterPage.js" ></script>

        <title>SCV - Motivos de Visita</title>
    </head>
    <body>
            ...
            <section id="ContenedorContent">
                    ...
                    <%@include file="../templates/left_nav_parametrizacion.html" %>   
                        ...
                        <form>
                            ...
                            <% } %>
                            <div id="grillaMotivosVisita"></div>
			</form>
