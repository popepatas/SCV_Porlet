...
<html>
    <head>
        ...
        <script type="text/javascript" src="../js/librerias/jquery.hashchange.min.js"></script>
        ...
        <script type="text/javascript" src="../js/funciones/parametrizacion/actividadesEconomicas.js"></script>
        <script type="text/javascript" src="../js/funciones/masterPage.js" ></script>
        
        <title>SCV - Actividades Econ&oacute;micas</title>
    </head>
    <body>
        <section id="Wrapper">
            ...
            <section id="ContenedorContent">
                    ...
                    <%@include file="../templates/left_nav_parametrizacion.html" %>                  
                        <% if(validar == false){ %>
                        <div id="div_actividad_economica" class="formularios">
                        ...
                        <div id="div_actividad_economica" class="formularios">
                            <h2>Actividades Económicas</h2>
                                ...
                                <div class="contenedorCodigo">
                                    <div class="etiquetas">
                                        <label for="codigoCiiu">
                                            Código CIIU<span class="campoObligatorio">*</span>:
                                        </label>
                                    </div>
                                    <div class="campos">
                                        <input  class="cmpRequerido" type="text" id="codigoCiiu" name="codigoCiiu" value=""  required  />
                                        <span class="k-invalid-msg" data-for="codigociiu"></span>
                                    </div>
                                </div>
                            ...
                            <% } %>
                        <%@include file="../templates/right_nav_parametrizacion.html" %>
                    <div id="grillaActEconomica" class="grilla-small"></div>
