...
<html>
    <head>
        ...
        <script type="text/javascript" src="../js/funciones/parametrizacion/tiposParamFisicoquimicos.js"></script>
        <script src="../js/funciones/masterPage.js" type="text/javascript"></script>
        
        <title>SCV - Tipos de Par&aacute;metros Fisicoqu&iacute;micos</title>
    </head>
	<body>
           ...
           <%@include file="../templates/header.html" %>
            ...
            <section id="ContenedorContent">
                ...
                <%@include file="../templates/left_nav_parametrizacion.html" %>  
                    ...
                    <div class="contenidoPrincipal" >
                        <form >
                            <div id="div_tipos_paramfiscoquim" class="formularios">
                                <h2>Tipos de Parámetros Fisicoquímicos</h2>
                        ...
                        <div id="grillaTiposParamFisicoquimicos"></div>
                    </div>
                    <% } %>
                </section>
            </section>
