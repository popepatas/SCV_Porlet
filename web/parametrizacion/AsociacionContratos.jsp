...
<html>
    <head>
        ...
        <script type="text/javascript" src="../js/funciones/parametrizacion/asociacionContratos.js"></script>
        
                        
        <title>SCV - Asociación de contratos </title>
    </head>
    <body>
        ...
        <section id="Wrapper">
            ...
            <section id="ContenedorContent">
                <section id="Content">
                    ...
                    <div class="contenidoPrincipal" >
                        <div id="div_asignacion_contratos" class="formularios">
                            <h2>Asociación Contratos</h2>

                            <div class="contenedorContrato">
                                <div class="etiquetas">
                                    <label for="contrato">
                                       Contrato Principal<span class="campoObligatorio">*</span>:
                                    </label>
                                </div>
                                <div class="campos">
                                    <input class="cmpRequerido k-textbox"  type="text" id="contrato" name="contrato" value="" required/>
                                    <span class="k-invalid-msg" data-for="contrato"></span>
                                </div>                               
                            </div>
                            <h3> Asignar Contratos:</h3>
                            <div id="contenedorAsignacionContrato">
                                <div class="contenedorContratoAsignado">
                                    <div class="etiquetas">
                                        <label for="contratoAsignado">
                                           Contrato Secundarios<span class="campoObligatorio">*</span>:
                                        </label>
                                    </div>
                                    <div class="campos">
                                        <input class="k-textbox"  type="text" name="contratoAsignado" id="contratoAsignado" data-mfd-name="contratoAsignado"  value="" required/>                                                                                
                                    </div>                                     
                                </div>
                    ...
                    <% } %>
                     <section class="contenedor-grilla">
                                        <div id="grillaAsociacionContratos" >
