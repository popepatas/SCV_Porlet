...
function enviarFormulario(){
    var validador = $("#div_Dashboard3").data("kendoValidator");
...
function limpiarFormulario() {
    ...
    $("#chartDashboard3").data("kendoChart").dataSource.data([]);
}

var dataSource;
function generarChart() {
    var url = servlet.consultar.dashboard3;
